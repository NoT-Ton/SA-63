...
func (e RoleEdges) RolesOrErr() ([]*User, error) {
	if e.loadedTypes[0] {
		return e.Roles, nil
	}
...
// QueryRoles queries the roles edge of the Role.
func (r *Role) QueryRoles() *UserQuery {
	return (&RoleClient{config: r.config}).QueryRoles(r)
}
