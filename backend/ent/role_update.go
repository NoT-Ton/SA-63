...
// AddRoles adds the roles edges to User.
...
// RemoveRoles removes roles edges to User.
...
func (ru *RoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := ru.mutation.RemovedRolesIDs(); len(nodes) > 0 {
...
func (ruo *RoleUpdateOne) sqlSave(ctx context.Context) (r *Role, err error) {
	...
	if nodes := ruo.mutation.RemovedRolesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   role.RolesTable,
