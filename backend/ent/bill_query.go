...
func (bq *BillQuery) QueryProduct() *ProductQuery {
...
func (bq *BillQuery) QueryUser() *UserQuery {
...
func (bq *BillQuery) WithProduct(opts ...func(*ProductQuery)) *BillQuery {
	query := &ProductQuery{config: bq.config}
...
func (bq *BillQuery) WithUser(opts ...func(*UserQuery)) *BillQuery {
	query := &UserQuery{config: bq.config}
	for _, opt := range opts {
		opt(query)
	}
...
func (bq *BillQuery) sqlAll(ctx context.Context) ([]*Bill, error) {
	...
	if bq.withProduct != nil || bq.withUser != nil || bq.withCustomer != nil {
		withFKs = true
	}
	if withFKs {
